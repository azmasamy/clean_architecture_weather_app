...
import 'package:clean_architecture_weather_app/weather/data/repository/weather_repository.dart';
...
import 'package:clean_architecture_weather_app/weather/domain/uescases/get_weather_by_city_name.dart';
...
void main() async {
  ...
  final Weather weather =
      await GetWeatherByCityName(baseWeatherRepository).execute('Istanbul');
  runApp(const MyApp());
}
